...
2. STD（Short-Term Disability，短期残障保险）类型：雇主或公司提供的私人福利，不是法律强制，和SDI类似，是生病或术后无法工作期间的收入补助，补助比例、时长根据公司计划而定（比如6周、8周），补助比例、时长根据公司计划而定（比如6周、8周）。申请方式是填写Metlife网站的表格。  
3. SDI（State Disability Insurance，加州州残障保险）(政府网站申请) 类型：加州项目，SDI是现金补助，不是假期，最长可领取52周。申请比较复杂。需要去SDI_Online网站注册账号，然后提交Claim申请。会产生一份表格，填好后可以网上提交。之后需要联系医生，提供申请号，医生会上传另一份表格。援助金会直接打到账上。
